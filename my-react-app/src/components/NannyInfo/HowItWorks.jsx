  ...
  const steps = [
    {
      ...
      title:
        "Κάνετε Εγγραφή στην σελίδα ntantades. Στην συνέχεια θα σας ζητηθεί να συμπληρώσετε μια φόρμα εγγραφής.Χρειάζεστε πιστοποιητικό υγείας απο παθολόγο, δερματολόγο και ψυχίατρο καθώς και μια υπέυθυνη δήλωση εγκυρότητας των δεδομένων που παρέχετε.",
    },
    {
